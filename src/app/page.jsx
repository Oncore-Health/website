  ...
  return (
    <>
      <div className="min-h-screen bg-white">
        ...
        {/* Hero Section */}
        <section id="hero" className="flex flex-col items-center text-center p-8 md:flex-row md:justify-between md:items-center px-16">
          <div className="md:w-1/2 text-left">
            ...
            <div className="flex space-x-4 justify-center md:justify-start">
              <a href="mailto:info@withoncore.com" className="bg-button text-white px-6 py-3 rounded-full hover:bg-darker transition">
                Schedule a Demo
              </a>
        ...
        <section id="built-by">
          <div className="relative z-10">
            <div className="relative mx-auto bg-white rounded-xl shadow-lg shadow-2xl border border-primary border-1 py-8 px-6 text-center lg:-mt-20 max-w-7xl bg-secondary">
        ...
        <div className="text-center mt-12">
            <h2 className="text-3xl font-bold text-gray-900">Why Oncare?</h2>
          </div>

          <div className="bg-white pb-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="flex flex-col justify-center items-start space-y-4 lg:mx-[10vw] sm:mx-[5vw]">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 px-6 mb-12">
            <div className="bg-white px-8 py-16 rounded-3xl shadow-lg hover:shadow-xl transition duration-300">
              ...
              <div className="text-center">
                <a href="mailto:info@withoncore.com" className="bg-tertiary text-primary px-4 py-2 rounded-full">
                  Contact Us
                </a>
              </div>
            </div>
            ...
            <div className="bg-white px-8 py-16 rounded-3xl shadow-lg hover:shadow-xl transition duration-300">
              ...
              <div className="text-center">
                <a href="mailto:info@withoncore.com" className="bg-tertiary text-primary px-4 py-2 rounded-full disabled">
                  Contact Us
                </a>
              </div>
            </div>
        ...
        <section id="integrations" className="py-16">
          ...
          <div className="text-center mt-12 text-primary hover:text-darker hover:underline">
            <a href="mailto:info@withoncore.com" className="font-medium flex justify-center items-center">
        ...
        <section id="security" className="relative bg-indigo-50 py-16 overflow-hidden">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Security and Scalability</h2>
          ...
          <div className="absolute top-0 right-[-15%] h-full w-full max-w-2xl opacity-10 z-0 pointer-events-none hidden lg:block">
            <img src="/oncore.png" alt="Oncore Logo" className="object-cover h-full" />
          </div>
          ...
          <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col items-center md:items-start text-center md:text-left md:ml-20">
              <div className="flex items-center justify-center md:justify-start space-x-2 mb-6">
                <img src="/oncore.png" alt="Oncore AI Logo" className="h-10" />
              ...
              <a href="mailto:info@withoncore.com" className="bg-primary text-white px-6 py-3 rounded-full hover:bg-darker transition mx-auto md:mx-0">
                Get Started
              </a>
            </div>

            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center text-center md:text-left md:justify-items-start md:mr-10">
              <div>
                <h4 className="text-lg font-semibold text-button mb-4">
                  AI Clinical Operations Platform
                </h4>
